<template>
  <div class="form-container">
    ...
    <form @submit.prevent="addStudents" class="student-form">
      <div class="form-row">
...
const addStudents = async () => {
  try {
    const nouvelEleve = await store.addStudents(form.value)

    if (nouvelEleve && nouvelEleve.id) {
      router.push(`students/${nouvelEleve.id}`)
    } else {
      console.error('Etudiant non existant.', store.error)
    }
  } catch (error) {
